...
# --- 두 번째 그래프 구역 (추가 예정 구역) ---
st.subheader("2. 두 번째 데이터 시각화 (예정)")
st.info("여기에 새로운 그래프(예: 누적관객수 막대그래프 등)가 추가될 예정입니다.")

# 미리 만들어두는 두 번째 인사이트 문구 자리
st.markdown("**💡 이 그래프로 알 수 있는 것:** *(여기에 새로운 인사이트를 한 문장으로 적어주세요)*")
